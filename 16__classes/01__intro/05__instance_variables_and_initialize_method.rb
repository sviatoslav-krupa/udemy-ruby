...
# errors because there are no reader and writer
...
phone.type      #=> undefined method 'type' for #<Gadget:0x00007fa9060b67b8 @username="User 61", @password="topsecret", @production_number="w-177"> (NoMethodError)
