...
[true, true, nil, true].sort    #=> comparison of TrueClass with nil failed (ArgumentError)
[true, true, "qwe", true].sort  #=> comparison of TrueClass with String failed (ArgumentError)
[true, 1, "qwe", 3].sort        #=> comparison of TrueClass with 1 failed (ArgumentError)
